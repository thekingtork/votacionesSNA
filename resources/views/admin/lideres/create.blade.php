...
<section class="wrapper site-min-height">
              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                    ...
                    {!! Form::open(['route' => 'administrador.lideres.store', 'method' => 'post']) !!}
                      @include('admin.lideres.partials.fields')
                      <button type="submit" class="btn btn-default">Crear lider</button>
                    {!! Form::close() !!} 
                  </div>
              </section>
              <!-- page end-->
